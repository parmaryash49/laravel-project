            ...
            <div class="row">
              <div class="col-sm-12 partner-detail-main">
                <div class="heading-part">
                  <h2 class="main_title " style="text-align: center;"><span>Welcome to our Site</span></h2>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-sm-12 partner-detail-main">
                <div class="heading-part mb-30">
                  <p class="footer-main">
					          <span>"A to Z Electronic System"</span> is a web site will allow customer to purchase a product using internet and It will provide online purchasing of various kinds of Mobiles, Teblets & Ipads.
